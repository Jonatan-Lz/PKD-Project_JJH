 ...
 */
export function build_list(fun, n) {
 ...
 */
export function member(elem, xs) {
    return is_null(xs)
        ? null
        : elem === head(xs)
            ? xs
 ...
 *      been removed.
 */
export function remove(elem, xs) {
 ...
 */
export function accumulate(op, initial, xs) {
 ...
 */
export function fold_left(f, initial, xs) {
    return is_null(xs)
        ? initial
